...
public class DefaultEventManagerTest implements EventListener {
	...
	public void testSubjectListenerWouldRegisterListener() {
		...
		// test concurrent modification of the queue ... on event listener would
		// attempt
		// adding another listener

		// add more than one listener to see that dispatch can proceed after one
		// of the
	...
	public void testValidSubclassOfRegisteredEventClass() throws Exception {
		...
		eventManager.postEvent(Mockito.spy(new CayenneEvent(this)), subject);
	...
	public void testWrongRegisteredEventClass() throws Exception {
		...
		// ..but post a subclass of EventObject that is not compatible with
		// CayenneEvent
