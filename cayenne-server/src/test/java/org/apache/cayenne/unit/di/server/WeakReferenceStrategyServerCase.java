...
public class WeakReferenceStrategyServerCase extends ServerCase {
	...
	static {
		...
		Mockito.doAnswer(invo -> {
			...
			ServerModule.contributeDefaultTypes(binder).add(new VoidType()).add(new BigDecimalType())
					.add(new BooleanType()).add(new ByteArrayType(false, true)).add(new ByteType(false))
					.add(new CharType(false, true)).add(new DateType()).add(new DoubleType()).add(new FloatType())
					.add(new IntegerType()).add(new LongType()).add(new ShortType(false)).add(new TimeType())
					.add(new TimestampType()).add(new UtilDateType()).add(new CalendarType<>(GregorianCalendar.class))
					.add(new CalendarType<>(Calendar.class));
			ServerModule.contributeUserTypes(binder);
			ServerModule.contributeTypeFactories(binder);
			ServerModule.contributeValueObjectTypes(binder).add(BigIntegerValueType.class).add(UUIDValueType.class)
					.add(LocalDateValueType.class).add(LocalTimeValueType.class).add(LocalDateTimeValueType.class)
			...
			binder.bind(Key.get(ResourceLocator.class, Constants.SERVER_RESOURCE_LOCATOR))
					.to(ClassLoaderResourceLocator.class);
		...
		injector = DIBootstrap.createInjector(res);
