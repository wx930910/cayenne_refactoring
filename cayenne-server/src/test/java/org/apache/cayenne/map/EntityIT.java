...
public class EntityIT extends ServerCase {
	...
	public void testName() {
		...
		Mockito.when(entity.translateToRelatedEntity(Mockito.any(), Mockito.any())).thenReturn(null);
		Mockito.when(entity.resolvePathComponents(Mockito.any(Expression.class))).thenReturn(null);
		Mockito.when(entity.resolvePath(Mockito.any(), Mockito.any())).thenReturn(null);
		Mockito.doNothing().when(entity).encodeAsXML(Mockito.any(), Mockito.any());
