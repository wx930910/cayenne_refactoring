...
public class AbstractQueryTest {
	...
	public void testSetInvalidRoot() {
		AbstractQuery query = Mockito.spy(AbstractQuery.class);
		Mockito.doReturn(null).when(query).createSQLAction(Mockito.any());
		Mockito.doReturn(null).when(query).getBaseMetaData();
		assertNull(query.getRoot());
		try {
