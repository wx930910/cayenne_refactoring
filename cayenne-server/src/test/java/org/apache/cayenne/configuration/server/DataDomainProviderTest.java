...
public class DataDomainProviderTest {
	...
	static private Resource mockMockResource1() {
		Resource mockInstance = Mockito.spy(Resource.class);
		try {
			...
			}).when(mockInstance).getRelativeResource(Mockito.any());
        ...
        Module testModule = binder -> {
            ...
            final ResourceLocator locator = new ClassLoaderResourceLocator(classLoaderManager) {
                ...
                public Collection<Resource> findResources(String name) {
                    ...
                    return Collections.<Resource>singleton(mockMockResource1());
                }
            };
