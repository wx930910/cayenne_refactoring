...
public class RuntimeBase extends ProtostuffProperties {
	...
	public void setUpRuntimes() throws Exception {
		this.serverRuntime = ServerRuntime.builder().addConfig("cayenne-protostuff.xml").build();

		Module module = binder -> {
			binder.bind(ClientConnection.class).toProviderInstance(new ProtostuffLocalConnectionProvider());
